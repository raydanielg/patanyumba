    ...
    <div class="overflow-x-auto">
        <table class="w-full text-sm" id="kycTable">
            ...
            <tbody id="kycBody">
                @php
                $docTypeIcons = [
                    'national_id' => '🪪', 'passport' => '📘', 'voters_id' => '🗳️',
                    'business_license' => '📜', 'brela_cert' => '🏛️', 'tin_cert' => '🔢',
                    'utility_bill' => '💡', 'title_deed' => '🏠', 'sale_agreement' => '📝',
                    'authorization_letter' => '✉️', 'selfie' => '🤳',
                ];
                $docTypeLabels = [
                ...
                <tr class="border-t border-gray-100 hover:bg-gray-50/50 transition-colors" id="row-{{ $doc->id }}">
                    ...
                    <td class="px-5 py-3">
                        <div class="flex items-center gap-2">
                            <span class="text-base">{{ $docTypeIcons[$doc->document_type] ?? '📄' }}</span>
